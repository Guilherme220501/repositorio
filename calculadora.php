...
<head>
    ...
    <style>
        ...
        h1{color :white;font-size: 30px;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;}
        legend{color: white;font-size: 30px;}
       label{color: red;font-size: 20px;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-style: oblique;text-shadow: 9px;}
    ...
    <div class="container">
        <div class="row g-2">
            ...
            <div class="d-grid gap-2 col-md-3 col-sm-12 mx-auto">
                <br>
                <button class="btn btn-outline-danger" id="btn-calcular" style="color:white;" onclick="processar();">Calcular</button>
            </div>           
        </div> 
